...
public class Process implements MsgHandler {
    ...
    public void sendMsg(int destId, String tag, int msg1, int msg2, int msg3) {
        sendMsg(destId,tag,String.valueOf(msg1)
                +" "+String.valueOf(msg2)+" " + String.valueOf(msg3) + " ");
    }

    public void sendMsg(int destId, String tag, Edge e) {
        sendMsg(destId, tag, e.toString() + " ");
    }

    public void sendMsg(int destId, String tag, int msg1, int msg2, NodeState state){
        sendMsg(destId, tag, String.valueOf(msg1) + " " + String.valueOf(msg2) + " " + state + " ");
    }

     public void sendMsg(int destId, String tag, int msg1, int msg2, String state){
        sendMsg(destId, tag, String.valueOf(msg1) + " " + String.valueOf(msg2) + " " + state + " ");
    }

    public void sendMsg(int destId, String tag, int msg1, int msg2, int msg3, NodeState state){
        sendMsg(destId, tag, String.valueOf(msg1) + " " + String.valueOf(msg2) + " " + String.valueOf(msg3)+ " " + state + " ");
    }

    public void sendMsg(int destId, String tag, int msg1, int msg2, int msg3, String state){
        sendMsg(destId, tag, String.valueOf(msg1) + " " + String.valueOf(msg2) + " " + String.valueOf(msg3)+ " " + state + " ");
    }
